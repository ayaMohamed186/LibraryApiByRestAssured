...
public class TC02_GetWishListByID extends TestBase {
    ...
    String getResponseWishListID,getResponseWishListName,getResponseWishListBooks, dateFormatRegex;
    ...
    public void checkGetBookById_P() {
        ...
        Assert.assertNotNull(response.jsonPath().getString("books"), "books in response is null");
